...
@register_metric
def fid50k_full(opts): # 统计数据集中的所有数据
    fid = frechet_inception_distance.compute_fid(opts, max_real=None, num_gen=50000)
    return dict(fid50k_full=fid)

@register_metric
def two_dataset_fid(opts): # 统计数据集中的所有数据
    fid = frechet_inception_distance.two_dataset_compute_fid(opts, max_real=None, num_gen=50000)
    return dict(two_dataset_fid=fid)
...
@register_metric
def fid50k(opts): # 统计数据集中的 50k 数据
